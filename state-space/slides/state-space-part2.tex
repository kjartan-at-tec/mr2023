...
\date{2021-05-27}
\title{Espacio de estados  - solución homógena y estabilidad}
\hypersetup{
 pdfauthor={Kjartan Halvorsen},
 pdftitle={Espacio de estados  - solución homógena y estabilidad},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:org155ab6c}

\begin{frame}[label={sec:org7beba31}]{Modelo compartimental}
 \small
\begin{columns}
...
\begin{frame}[label={sec:org3f707e7}]{Modelo compartimental}
 \small
\begin{columns}
  \begin{column}{0.5\linewidth}
    \begin{center}
...
\begin{frame}[label={sec:org4fc00ac}]{Solución homógena de sistemas en espacio de estados}
\footnotesize
   \[\dot{x} &= Ax\]
...
\begin{frame}[label={sec:org6b006b6}]{Estabilidad}
